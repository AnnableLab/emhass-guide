...
Despite its daunting sophistication at first glance, HAEO is quite simple at its core. You feed in 4 forecast values,
...
HAEO will take all this information and generate an energy plan that is optimal for a given goal. The goal can be to
...
You can also visualize this energy plan in a dashboard and see what HAEO has decided to do:
